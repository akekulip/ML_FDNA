...
| 6b | The repaired FDNA arm beats plain dependency logic given the same head (registry/phase3_step2.yaml's own attribution rule) | NOT SUPPORTED (P1 complete, well-powered) | results/phase4/RESULTS.md: J_OR_hard_CC KL 0.174+-0.008 vs L_CC 0.099+-0.006, L_indep 0.103+-0.005 -- repaired FDNA arm is WORSE than plain logic with the same joint head; ties the generic MLP. P2 (v2c) pending to confirm. |
