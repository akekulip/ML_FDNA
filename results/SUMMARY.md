...
1. **Confirmed and replicated, small, non-FDNA.** Learning the value model on full-information simulation rows and the inference module on cheap
   ...
   +0.025 (P2) R-precision on two independent fresh blocks (tier 2: reliable but below the pre-declared 0.05). About half of this is the choice of inference
